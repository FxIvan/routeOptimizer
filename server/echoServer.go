...
import (
	...
	cockroachHandlers "github.com/fxivan/routeOptimizer/cockroach/handlers"
	cockroachRepositories "github.com/fxivan/routeOptimizer/cockroach/repositories"
	cockroachUsecases "github.com/fxivan/routeOptimizer/cockroach/usecases"
...
func (s *echoServer) initializeCockroachHttpHandler() {
	...
	cockroachRouters.GET("", cockroachHttpHandler.TransactionSearchCockroach)
}
